<%-- 
    Document   : centralpagInicial
    Created on : 11/08/2014, 12:30:29
    Author     : 1946810
--%>

      
            <form action="CadastrarUsuario" method="post">
                <table id="tabelBotoes" style="position: absolute;
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <select name="txtLogradouroTipo">
                                ...
                                <input required type="text" name="txtLogradouro"
                                       maxlength="50"/>
                        </td>
                        <td>
                            <p>Número</p>
                                <input required type="number" name="txtNumero" 
                                       maxlength="4"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <td>
                        <div id="areaAposentado">
                                <p>Tipo de Aposentadoria</p>
                                    <input required type="text" name="txtTipoAposentadoria" /> 
                    </td>
                    
                        <td>
                            <p>RMI</p>
                                <input required type="number" name="txtRMI" />
                        </td>
                        <td>
                            <p>DIB</p>
                            <input required="true" type="date" name="txtDIB" />                                                  
                        </td>                                            
                    <tr>
                        <td>
